                        ...
                        <div className='column-3'>
                            <div className='ecard'>
                                <div>
                                    ...
                                    <div className='ecard-title'>Data Analytics Essentials</div>
                                    <div className='ecard-date'>Cisco | 5/29/2026</div>
                                    <div className='ecard-link'><a href='https://www.credly.com/badges/a'>Link</a></div>
                                </div>
                                <div>
                            ...
                            <div className='ecard'>
                                <div>
                                    ...
                                    <div className='ecard-title'>JavaScript Essentials 1</div>
                            ...
                            <div className='ecard'>
                                <div>
                                    ...
                                    <div className='ecard-title'>CSS Essentials</div>
                            ...
                            <div className='ecard'>
                                <div>
                                    <div className='ecard-title'>JavaScript Essentials 2</div>
                            ...
                            <div className='ecard'>
                                <div>
                                    <div className='ecard-title'>HTML Essentials</div>
                            ...
                            <div className='ecard'>
                                <div>
                                    <div className='ecard-title'>IT Customer Support Basics</div>
                            ...
                            <div className='ecard'>
                                <div>
                                    <div className='ecard-title'>Introduction to Modern AI</div>
                                    <div className='ecard-date'>Cisco | 8/31/2026</div>
                                    <div className='ecard-link'><a href='https://www.credly.com/badges/a'>Link</a></div>
                                </div>
                        ...
                        <div className='column-1'>
                            <div>
                                <div className='gcard'>
                                    ...
                                    <button className='gcard-desc'>Download</button>
                                </div>
                            ...
                            <div>
                                <div className='gcard'>
                                    ...
                                    <div className='gcard-aaa'>
                                        ...
                                        <div>
                                            <div className='gcard-link'><a href='https://www.facebook.com/a'>ag</a></div>
                                            <div className='gcard-link'><a href='www.linkedin.com/in/a'>a</a></div>
                                            <div className='gcard-link'>gamengreign2005@gmail.com</div>
                                        </div>
                            ...
                            <div>
                                <div className='gcard'>
                                    ...
                                    <div className='gcard-aaa'>
                                        ...
                                        <div>
                                            <div className='gcard-link'><a href='https://www.credly.com/users/'>a</a></div>
                                    <div className='gcard-link'><a href='https://github.com/'>a</a></div>
                                        </div>
